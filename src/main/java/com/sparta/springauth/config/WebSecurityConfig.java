...
public class WebSecurityConfig {
    ...
    private final AuthenticationConfiguration authenticationConfiguration; // Authentication Manager 만들 것임
    ...
    // AuthenticationConfiguration을 통해 생성돼서 수동으로 Bean 등록
    @Bean
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // 필터 관리 (필터를 생성했을 뿐이지 Spring Security Filter에 언제 끼워넣으라고 알려준 적이 없으니 알려주는 코드)
